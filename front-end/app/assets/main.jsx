...
var ChirpStream = React.createClass({
    ...
    render: function() {
        var chirpNodes = this.state.chirps.map(function(chirp) {
            ...
            return (
                <Chirp uuid={chirp.uuid}
                       userId={chirp.userId}
                       userName={userName}
                       key={chirp.uuid}
                       isFavorite={chirp.isFavorite}
                       favorCount={chirp.favorCount}>
                    {chirp.message}
                </Chirp>
            );
        }.bind(this));
        ...
        if (this.state.enable) {
            return (
                <ul className="favorite">
                    <li className="favorite-icon enable" onClick={this.disable}></li>
                    <li className="favor-count">{this.props.favorCount}</li>
                </ul>
            );
        } else {
            return (
                <ul className="favorite">
                    <li className="favorite-icon disable" onClick={this.enable}></li>
                    <li className="favor-count">{this.props.favorCount}</li>
                </ul>
            );
        }
